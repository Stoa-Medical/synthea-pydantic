...
class Encounter(BaseModel):
    ...
    encounterclass: Literal["ambulatory", "emergency", "inpatient", "wellness", "urgentcare"] = Field(description="The class of the encounter, such as ambulatory, emergency, inpatient, wellness, or urgentcare")
    code: str = Field(description="Encounter code from SNOMED-CT")
    description: str = Field(description="Description of the type of encounter")
