...
class Patient(SyntheaBaseModel):
    ...
    lat: Optional[float] = Field(None, alias='LAT', description="Latitude of Patient's address")
    lon: Optional[float] = Field(None, alias='LON', description="Longitude of Patient's address")
