...
class Procedure(BaseModel):
    ...
    stop: datetime = Field(description="The date and time the procedure was completed")
    ...
    reasoncode: Optional[str] = Field(None, description="Diagnosis code from SNOMED-CT specifying why the procedure was performed")
